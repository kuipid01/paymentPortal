...
const CardDetail = () => {
  ...
  return curUser ? (
    <>
      <button onClick={handleBack} size="sm" className="mb-2" color="transparent">
        &lt; Back
      </button>
      {cardHolder ? (
        <>
          ...
          <div className="desktop appear">
            ...
            <button onClick={handleDelete} color={'red'} className="mt-3">
              Delete
            </button>
            <hr />
            <p>Open Mypay on your phone in portrait mode to use the pay function!</p>
          </div>
